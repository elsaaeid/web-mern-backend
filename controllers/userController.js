...
const sendLoginCode = asyncHandler(async (req, res) => {
  ...
  // Send Login Code
  const subject = "Login Access Code - AUTH:Average-Solution";
  const send_to = email;
...
const sendVerificationEmail = asyncHandler(async (req, res) => {
  ...
  // Send Email
  const subject = "Verify Your Account - AUTH:Average-Solution";
...
const forgotPassword = asyncHandler(async (req, res) => {
  ...
  // Send Email
  const subject = "Password Reset Request - AUTH:Average-Solution";
  const send_to = user.email;
  const sent_from = process.env.EMAIL_USER;
  const reply_to = "saidsadaoy@gmail.com";
